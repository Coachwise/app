...
export function NumberInput({
  ...
  const stepBtn = 'flex items-center justify-center w-8 shrink-0 text-gray-500 hover:text-navy active:bg-gray-100 disabled:opacity-40 disabled:hover:text-gray-500';

  return (
    <div
      className={cn(
        'inline-flex items-stretch rounded-lg border border-gray-300 bg-white overflow-hidden focus-within:ring-2 focus-within:ring-yellow-500 focus-within:border-transparent',
        disabled && 'opacity-60',
        className,
      )}
    >
      ...
      <input
        ...
        className={cn(
          'min-w-0 flex-1 bg-transparent px-2 py-2 text-navy tabular-nums outline-none text-center disabled:cursor-not-allowed',
